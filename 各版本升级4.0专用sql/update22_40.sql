...
--
ALTER TABLE  `tqk_user` ADD  `pdd_pid` VARCHAR( 30 ) NULL ,ADD  `oid` VARCHAR( 60 ) NULL ,ADD  `tbname` VARCHAR( 50 ) NULL; 

ALTER TABLE  `tqk_user` CHANGE  `webmaster_pid`  `webmaster_pid` VARCHAR( 30 ) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ;


ALTER TABLE  `tqk_finance` ADD  `type` TINYINT( 1 ) NULL DEFAULT  '1';

ALTER TABLE  `tqk_order` ADD  `oid` VARCHAR( 60 ) NULL ;
--
