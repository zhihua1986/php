...
return array(
    ...
    'DATA_CACHE_PREFIX'      => 'TQK_', // 缓存前缀
    'DATA_CACHE_TYPE'        => 'File', // 数据缓存类型,支持:File|Db|Apc|Memcache|Shmop|Sqlite|Xcache|Apachenote|Eaccelerator
    'DATA_CACHE_PATH'        => TEMP_PATH, // 缓存路径设置 (仅对File方式缓存有效)
    'DATA_CACHE_KEY'         => 'tuiquanke', // 缓存文件KEY (仅对File方式缓存有效)
    ...
    'TAGLIB_BUILD_IN'        => 'cx,Common\TagLib\TagLibLoad', // 内置标签库名称(标签使用不必指定标签库名称),以逗号分隔 注意解析顺序
