...
$items_list = $this->_mod->where($where)->field('id,pic_url,num_iid,title,change_price,mobilezk,coupon_price,commission_rate,price,quan,shop_type,volume,add_time')->order($order)->limit($start . ',' . $size)->select();	
...
$this->assign('list',$goodslist);
 ...
 $this->_config_seo([
            'title' => '2022天猫618预售实时热销爆款榜 - '. C('yh_site_name'),
            'keywords' => '2022天猫双618',
