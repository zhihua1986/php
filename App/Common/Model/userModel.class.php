...
protected $fields = array('id','username','nickname','password','phone','email','avatar','money','score','wechat'
,'qq','address','reg_ip','reg_time','last_time','last_ip','login_count','create_time','state','status','openid','frozen','webmaster'
,'webmaster_pid','webmaster_rate','pdd_pid','oid','tbname','fuid','guid','invocode','realname'
,'alipay','relation_id','special_id','tb_refresh_token','tb_ expire_time','tb_ access_token','tb_open_uid','jd_pid','wxAppOpenid','bdAppOpenid','opid'
,'unionid');
protected $pk     = 'id';
