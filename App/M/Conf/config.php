...
return array (
  ...
  '/^cate\/cid\/(\d+)\/sid\/(\d+)$/' => 'cate/index?cid=:1&sid=:2',
    ...
    '/^sou\/$/' => 'sou/index',
     '/^so$/' => 'so/index',
    '/^so\/from\/(.*?)\/k\/(.*?)$/' => 'so/index?from=:1&k=:2',
     '/^so\/from\/(.*?)$/' => 'so/index?from=:1',
    'sou/:id' => 'sou/index',
   ...
   // '/^help\/(\d+)$/' => 'help/read?id=:1',
    ...
    '/^pdditem\/iid\/(.*?)$/' => 'pdditem/index?iid=:1',
    ...
    '/^brand\/cateid\/(.*?)$/' => 'brand/index?cateid=:1',
    '/^topics\/$/' => 'topics/index',
    'topics/:id' => 'topics/index',
    '/^waxianbao/' => 'waxianbao/index',
    '/^waxianbao\/tab\/(\d+)$/' => 'waxianbao/index?tab=:1',
        '/^promotion/' => 'promotion/index',
        '/^promotion\/tab\/(\d+)$/' => 'promotion/index?tab=:1',
     '/^tophot$/' => 'tophot/index',
